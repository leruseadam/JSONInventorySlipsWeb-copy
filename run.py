...
def parse_arguments():
    ...
    parser.add_argument('--host', type=str, default='0.0.0.0',
                        help='Host to bind (default: 0.0.0.0 — open http://127.0.0.1:PORT in browser)')
    parser.add_argument('--port', type=int, default=8000,
                        help='Port to run the server on (default: 8000, same as python app.py)')
...
def main():
    ...
    if args.host in ('0.0.0.0', '::'):
        print(f"  In your browser: http://127.0.0.1:{args.port}/")
